...
require_line 'platform_abi=1.9'
require_line 'launcher_abi=1'
require_line 'sailfish_wire=1.10'
...
if grep -E -v '^(format=3|source_mode=(committed|development)|target_arch=aarch64|rockpool_commit=[0-9a-f]{40}|mobileapp_commit=[0-9a-f]{40}|builder_image_id=sha256:[0-9a-f]{64}|platform_abi=1\.9|launcher_abi=1|sailfish_wire=1\.10|artifact_sha256=[0-9a-f]{64} [0-9A-Za-z._+-]+)$' \
