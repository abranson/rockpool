...
class RockpoolPebbleInterface : public QDBusAbstractInterface
{
    Q_OBJECT

public:
    explicit RockpoolPebbleInterface(const QString &path, QObject *parent = 0);
...
private:
    ...
    int m_model = 0;
    RockpoolPebbleInterface *m_iface;
