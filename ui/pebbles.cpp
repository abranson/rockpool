...
#define ROCKPOOL_SERVICE QStringLiteral("org.rockpool")
#define ROCKPOOL_MANAGER_PATH QStringLiteral("/org/rockpool/Manager")
#define ROCKPOOL_MANAGER_INTERFACE QStringLiteral("org.rockpool.Manager")

static QDBusPendingCall callManager(const QString &method,
                                    const QVariantList &arguments = QVariantList())
{
    QDBusMessage message = QDBusMessage::createMethodCall(
        ROCKPOOL_SERVICE, ROCKPOOL_MANAGER_PATH, ROCKPOOL_MANAGER_INTERFACE, method);
    ...
    QAbstractListModel(parent)
{
    ...
    m_watcher = new QDBusServiceWatcher(ROCKPOOL_SERVICE, QDBusConnection::sessionBus(), QDBusServiceWatcher::WatchForOwnerChange, this);
    QDBusConnection::sessionBus().connect(ROCKPOOL_SERVICE, ROCKPOOL_MANAGER_PATH, ROCKPOOL_MANAGER_INTERFACE, "PebblesChanged", this, SLOT(refresh()));
    QDBusConnection::sessionBus().connect(ROCKPOOL_SERVICE, ROCKPOOL_MANAGER_PATH, ROCKPOOL_MANAGER_INTERFACE, "ScanningChanged", this, SLOT(onScanningChanged(bool)));
    QDBusConnection::sessionBus().connect(ROCKPOOL_SERVICE, ROCKPOOL_MANAGER_PATH, ROCKPOOL_MANAGER_INTERFACE, "ScanResultsChanged", this, SLOT(refreshScanResults()));
