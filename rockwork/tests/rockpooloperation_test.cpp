/*
 * Regression coverage for asynchronous org.rockpool.Operation1 monitoring.
 *
...
const char operationPath[] = "/org/rockpool/Operations/test";
...
public:
    ...
    QString introspect(const QString &path) const Q_DECL_OVERRIDE
    {
        ...
        return QStringLiteral(
                    ...
                    "</method>"
                    "</interface>"
                    "<interface name=\"org.rockpool.Operation1\">"
                    "<method name=\"Cancel\"/>"
...
void RockpoolOperationTest::propertiesChangedUpdatesProgressAndTerminalPayload()
{
    ...
    terminal.insert(QStringLiteral("Error"), QStringLiteral("org.rockpool.Error.Internal"));
    ...
    QCOMPARE(operation.progress(), 1.0);
    QCOMPARE(operation.result(), result);
    QCOMPARE(operation.error(), QStringLiteral("org.rockpool.Error.Internal"));
...
void RockpoolOperationTest::cancelIsAsyncAndIdempotent()
{
    ...
    terminal.insert(QStringLiteral("Error"), QStringLiteral("org.rockpool.Error.Cancelled"));
