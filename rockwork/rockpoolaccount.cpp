...
namespace {
const char ACCOUNT_INTERFACE[] = "org.rockpool.Account1";
const char ACCOUNT_PATH[] = "/org/rockpool/Manager";
const char OPERATION_PATH_PREFIX[] = "/org/rockpool/Operations/";
