...
class RockpoolFirmwareStatusTest {
    @Test
     ...
     * The test remains red until RockpoolUiService tracks the complete exposed tuple instead of
    ...
    private fun status(
        ...
        val type = Class.forName(
            "io.rebble.libpebblecommon.ui.RockpoolFirmwareStatus",
        )
