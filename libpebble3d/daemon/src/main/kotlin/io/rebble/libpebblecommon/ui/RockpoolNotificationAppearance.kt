...
internal data class RockpoolNotificationAppearance(
 ...
 */
internal class RockpoolNotificationAppearanceCoordinator(
    private val libPebble: LibPebble,
) {
    private val logger = Logger.withTag("RockpoolNotificationAppearance")
    private val mutex = Mutex()
    private val pending = mutableMapOf<String, Pending>()

    private data class Pending(
        val expected: RockpoolNotificationAppearance,
        val preceding: Set<RockpoolNotificationAppearance>,
    )
    ...
    private suspend fun update(
        sourceId: String,
        transform: (RockpoolNotificationAppearance) -> RockpoolNotificationAppearance,
    ...
    private suspend fun current(sourceId: String): RockpoolNotificationAppearance? =
    ...
    private fun resolve(
        sourceId: String,
        actual: RockpoolNotificationAppearance,
...
private fun io.rebble.libpebblecommon.database.entity.NotificationAppItem.appearance() =
    RockpoolNotificationAppearance(vibePatternName, colorName, iconCode)
