...
/**
 * Reproduces rockpoold's one-button, mixed-transport discovery on top of libpebble3's deliberately
 * exclusive BLE and BR/EDR scanners. Results are accumulated by [RockpoolUiService] while this
 * session runs; each scanner owns the adapter for one half of the legacy discovery window.
 */
internal class RockpoolMixedScanSession(
